...
1	admin	1605193086180	Successful admin console login attempt	xmpp.localhost.example	The user logged in successfully to the admin console from address 172.70.0.1.
2	admin	1605193167191	created new user user1	xmpp.localhost.example	name = User One, email = null, admin = false
3	admin	1605193178661	created new user user2	xmpp.localhost.example	name = User Two, email = null, admin = false
4	admin	1605193216992	created new MUC room muc1	xmpp.localhost.example	subject = \nroomdesc = First MUC room\nroomname = MUC One\nmaxusers = 30
5	admin	1605193235018	created new MUC room muc2	xmpp.localhost.example	subject = \nroomdesc = Second MUC room\nroomname = MUC Two\nmaxusers = 30
\.
