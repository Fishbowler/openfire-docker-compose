...
plugin.httpfileupload.announcedWebHost	xmpp.localhost.example	0	\N
plugin.httpfileupload.announcedWebPort	27070	0	\N
...
2	admin	1605193121343	enabled clustering	xmpp1.localhost.example	\N
3	admin	1605193167191	created new user user1	xmpp1.localhost.example	name = User One, email = null, admin = false
