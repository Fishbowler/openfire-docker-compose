...
1	openfireadmin@xmpp.localhost.example	10
2	openfireadmin@xmpp.localhost.example	10
\.
...
ldap.debugEnabled	false	0	\N
admin.authorizedJIDs	openfireadmin@xmpp.localhost.example	0	\N
cache.MUCService'conference'Rooms.maxLifetime	-1	0	\N
cache.MUCService'conference'Rooms.size	-1	0	\N
update.lastCheck	1643228923357	0	\N
ldap.host	ldap	0	\N
ldap.port	389	0	\N
ldap.baseDN	dc=test,dc=igniterealtime,dc=org	0	\N
ldap.adminDN	cn=readonly,dc=test,dc=igniterealtime,dc=org	0	\N
ldap.adminPassword	readonly	0	\N
ldap.connectionPoolEnabled	true	0	\N
ldap.sslEnabled	false	0	\N
ldap.startTlsEnabled	false	0	\N
ldap.ldapDebugEnabled	false	0	\N
ldap.autoFollowReferrals	false	0	\N
ldap.autoFollowAliasReferrals	true	0	\N
ldap.usernameField	uid	0	\N
...
provider.vcard.className	org.jivesoftware.openfire.ldap.LdapVCardProvider	0	\N
ldap.nameField	{cn}	0	\N
ldap.emailField	mail	0	\N
ldap.override.avatar	false	0	\N
provider.user.className	org.jivesoftware.openfire.ldap.LdapUserProvider	0	\N
provider.auth.className	org.jivesoftware.openfire.ldap.LdapAuthProvider	0	\N
ldap.groupNameField	cn	0	\N
ldap.groupMemberField	member	0	\N
ldap.groupDescriptionField	description	0	\N
ldap.posixMode	false	0	\N
ldap.groupSearchFilter	(objectClass=groupOfMembers)	0	\N
provider.group.className	org.jivesoftware.openfire.ldap.LdapGroupProvider	0	\N
\.
...
pubsub		0	001643228887928	001643228887928	\N	0	0	0	0	1	1	1	0	0	publishers	1	0	open				xmpp.localhost.example		English		\N	all	-1
\.
...
openfireadmin	console.rows_per_page	/server-properties.jsp=25,/group-summary.jsp=25,/group-edit.jsp=25
\.
